...
?>
                    ...
                    <ul>
                      <li class="body"><a href="mrbs/" class="body">Demonstration installation</a></li>
                      <li class="body"><a href="periodsmrbs/">Demonstration using periods</a></li>
                      <li class="body"><a href="mrbs/admin.php">Admin pages</a></li>
                      <li class="body"><a href="mrbs/help.php">Additional Help</a></li>
                    </ul>
                    <p class="body">
