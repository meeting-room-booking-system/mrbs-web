...
<title>MRBS: Screenshot <? echo $file ?></title>
<!-- #EndEditable -->
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#0066FF">
        ...
        <tr> 
          ...
          <td colspan="2" valign="middle" bgcolor="#FFFFFF"> 
            <h1><!-- #BeginEditable "title" -->MRBS Screenshot: <? echo $file ?><!-- #EndEditable --></h1>
          </td>
        </tr>
        <tr> 
          <td height="12"></td>
        ...
        <tr>
          <td height="337"></td>
          <td colspan="3" valign="top"><!-- #BeginEditable "body" --> <IMG SRC="<? echo $file ?>"> 
            <!-- #EndEditable --> </td>
          <td></td>
        </tr>
        <tr>
